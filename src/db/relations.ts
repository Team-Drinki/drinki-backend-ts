...
export const alcoholCategoriesRelations = relations(
  alcoholCategories,
  ({ many }) => ({
...
export const alcoholStylesRelations = relations(
  alcoholStyles,
  ({ one, many }) => ({
    category: one(alcoholCategories, {
...
export const alcoholLocationsRelations = relations(
  alcoholLocations,
  ({ many }) => ({
    alcohols: many(alcohols),
    alcoholRequests: many(alcoholRequests),
...
export const alcoholRequestsRelations = relations(
  alcoholRequests,
  ({ one }) => ({
    user: one(users, {
...
export const flavorCategoriesRelations = relations(
  flavorCategories,
  ({ many }) => ({
